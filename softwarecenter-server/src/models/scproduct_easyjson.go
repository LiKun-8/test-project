...
func easyjsonE500707dDecodeModels(in *jlexer.Lexer, out *ScProduct) {
...
func easyjsonE500707dEncodeModels(out *jwriter.Writer, in ScProduct) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v ScProduct) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE500707dEncodeModels(&w, v)
...
func (v *ScProduct) UnmarshalJSON(data []byte) error {
	...
	easyjsonE500707dDecodeModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ScProduct) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE500707dDecodeModels(l, v)
}
