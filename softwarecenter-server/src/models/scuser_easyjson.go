...
func easyjson9228ff33DecodeModels(in *jlexer.Lexer, out *ScUser) {
...
func easyjson9228ff33EncodeModels(out *jwriter.Writer, in ScUser) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v ScUser) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9228ff33EncodeModels(&w, v)
...
func (v *ScUser) UnmarshalJSON(data []byte) error {
	...
	easyjson9228ff33DecodeModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ScUser) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9228ff33DecodeModels(l, v)
}
