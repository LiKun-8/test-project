...
func easyjson5a27f2ffDecodeModels(in *jlexer.Lexer, out *ScComment) {
	...
	for !in.IsDelim('}') {
		...
		case "comment_Date":
			easyjson5a27f2ffDecodeGithubComGoSqlDriverMysql(in, &out.CommentDate)
		default:
			in.SkipRecursive()
		}
		in.WantComma()
...
func easyjson5a27f2ffEncodeModels(out *jwriter.Writer, in ScComment) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
	...
	easyjson5a27f2ffEncodeGithubComGoSqlDriverMysql(out, in.CommentDate)
	out.RawByte('}')
}
...
func (v ScComment) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5a27f2ffEncodeModels(&w, v)
...
func (v *ScComment) UnmarshalJSON(data []byte) error {
	...
	easyjson5a27f2ffDecodeModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ScComment) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5a27f2ffDecodeModels(l, v)
}
func easyjson5a27f2ffDecodeGithubComGoSqlDriverMysql(in *jlexer.Lexer, out *mysql.NullTime) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson5a27f2ffEncodeGithubComGoSqlDriverMysql(out *jwriter.Writer, in mysql.NullTime) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
