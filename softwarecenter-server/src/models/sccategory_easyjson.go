...
func easyjson215cba02DecodeModels(in *jlexer.Lexer, out *ScCategory) {
...
func easyjson215cba02EncodeModels(out *jwriter.Writer, in ScCategory) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v ScCategory) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson215cba02EncodeModels(&w, v)
...
func (v *ScCategory) UnmarshalJSON(data []byte) error {
	...
	easyjson215cba02DecodeModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ScCategory) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson215cba02DecodeModels(l, v)
}
