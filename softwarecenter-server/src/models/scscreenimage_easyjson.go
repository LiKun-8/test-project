...
func easyjsonE2850ba7DecodeModels(in *jlexer.Lexer, out *ScScreenImage) {
...
func easyjsonE2850ba7EncodeModels(out *jwriter.Writer, in ScScreenImage) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v ScScreenImage) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE2850ba7EncodeModels(&w, v)
...
func (v *ScScreenImage) UnmarshalJSON(data []byte) error {
	...
	easyjsonE2850ba7DecodeModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ScScreenImage) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE2850ba7DecodeModels(l, v)
}
