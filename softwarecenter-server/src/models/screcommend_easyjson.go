...
func easyjson5325e3c6DecodeModels(in *jlexer.Lexer, out *ScRecommend) {
...
func easyjson5325e3c6EncodeModels(out *jwriter.Writer, in ScRecommend) {
	out.RawByte('{')
	first := true
	_ = first
	if !first {
...
func (v ScRecommend) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson5325e3c6EncodeModels(&w, v)
...
func (v *ScRecommend) UnmarshalJSON(data []byte) error {
	...
	easyjson5325e3c6DecodeModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ScRecommend) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson5325e3c6DecodeModels(l, v)
}
